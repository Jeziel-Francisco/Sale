...
//#endregion
var PermissionsBusiness = /** @class */ (function () {
    function PermissionsBusiness() {
    }
    //#region  FindById
    PermissionsBusiness.prototype.findById = function (res, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, permissions_service_1.default.findById(id)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus, data);
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
    ...
    //#endregion
    //#region  Create
    PermissionsBusiness.prototype.create = function (res, permissions) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, permissions_service_1.default.create(permissions)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus, data);
                        return [3 /*break*/, 3];
    ...
    //#endregion
    //#region  Update
    PermissionsBusiness.prototype.update = function (res, id, permissions) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, permissions_service_1.default.update(id, permissions)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus, data);
                        return [3 /*break*/, 3];
    ...
    //#endregion
    //#region  remove
    PermissionsBusiness.prototype.remove = function (res, id) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, permissions_service_1.default.remove(id)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus, data);
                        return [3 /*break*/, 3];
