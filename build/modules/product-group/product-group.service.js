...
var ProductGroupService = /** @class */ (function (_super) {
    ...
    function ProductGroupService() {
        return _super.call(this, models.ProductGroup, ['description', 'productId', 'groupId'], ['id', 'description', 'productId', 'groupId']) || this;
    }
    return ProductGroupService;
}(interface_service_modules_1.default));
exports.default = new ProductGroupService;
