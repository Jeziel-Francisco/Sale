...
var ClientService = /** @class */ (function () {
    ...
    ClientService.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, models.Client.findOne({ where: { id: id } })];
    ...
    ClientService.prototype.create = function (client) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, models.Client.create(client)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ClientService.prototype.update = function (id, client) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, models.Client.update(client, {
                            where: { id: id },
