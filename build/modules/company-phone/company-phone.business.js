...
//#endregion
var CompanyPhoneBusiness = /** @class */ (function () {
    function CompanyPhoneBusiness() {
    }
    //#region FindById
    CompanyPhoneBusiness.prototype.findById = function (res, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, company_phone_service_1.default.findById(id)];
                    case 1:
                        data = _a.sent();
    ...
    //#endregion
    //#region  Create
    CompanyPhoneBusiness.prototype.create = function (res, companyPhone) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, company_phone_service_1.default.create(companyPhone)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
    ...
    //#endregion
    //#region  Update
    CompanyPhoneBusiness.prototype.update = function (res, id, companyPhone) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, company_phone_service_1.default.update(id, companyPhone)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
    ...
    //#endregion
    //#region  Remove
    CompanyPhoneBusiness.prototype.remove = function (res, id) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, company_phone_service_1.default.remove(id)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
