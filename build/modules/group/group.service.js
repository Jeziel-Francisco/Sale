...
var GroupService = /** @class */ (function (_super) {
    ...
    function GroupService() {
        return _super.call(this, models.Group, ['description', 'active'], ['id', 'description', 'active']) || this;
    }
    GroupService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, models.Group.update({ active: false, cancellationDate: Date.now }, {
                            where: { id: id },
