...
//#endregion
var ClientPhoneBusiness = /** @class */ (function () {
    function ClientPhoneBusiness() {
    }
    //#region  FindById
    ClientPhoneBusiness.prototype.findById = function (res, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, client_phone_service_1.default.findById(id)];
                    case 1:
                        data = _a.sent();
    ...
    //#endregion
    //#region  Create
    ClientPhoneBusiness.prototype.create = function (res, phoneClient) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, client_phone_service_1.default.create(phoneClient)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
    ...
    //#endregion
    //#region  Update
    ClientPhoneBusiness.prototype.update = function (res, id, phoneClient) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, client_phone_service_1.default.update(id, phoneClient)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
    ...
    //#endregion
    //#region  Remove
    ClientPhoneBusiness.prototype.remove = function (res, id) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, client_phone_service_1.default.remove(id)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
