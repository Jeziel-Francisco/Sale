...
//#endregion
var StateBusiness = /** @class */ (function () {
    function StateBusiness() {
    }
    //#region  FindById
    StateBusiness.prototype.findById = function (res, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, state_service_1.default.findById(id)];
                    case 1:
                        data = _a.sent();
    ...
    //#endregion
    //#region  Create
    StateBusiness.prototype.create = function (res, state) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, state_service_1.default.create(state)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
    ...
    //#endregion
    //#region  update
    StateBusiness.prototype.update = function (res, id, state) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, state_service_1.default.update(id, state)];
                    case 1:
                        data = _a.sent();
                        response_default_1.default(res, HttpStatus.OK, data);
                        return [3 /*break*/, 3];
...
exports.default = new StateBusiness();
