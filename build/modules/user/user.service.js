...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, model.User.create(user)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    UserService.prototype.updatePassword = function (id, passwordUpdated) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, model.User.update(passwordUpdated, {
                            where: { id: id },
                            fields: ['password']
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
    ...
    UserService.prototype.updateUsername = function (id, usernameUpdated) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, model.User.update(usernameUpdated, {
                            where: { id: id },
                            fields: ['username']
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
